{if $graph && $graph.content}{strip}
    ...
    *}
    ...
    <div class="analytics-card-graph"
        ...
        data-ca-analytics-card-graph-previous-period-text="{__("previous_period")}"
        data-ca-analytics-card-graph-current-period-text="{__("current_period")}"
        data-ca-analytics-card-graph-current-previous-period-text="{__("current_previous_period", ["[date]" => "MMM d, yyyy"])}"
