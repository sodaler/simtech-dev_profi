(function (_, $) {
  function drawAnalyticsCardGraph(is_day) {
    ...
    function get_data(div) {
      ...
      var previousPeriodText = $graph.data('caAnalyticsCardGraphPreviousPeriodText');
      var currentPeriodText = $graph.data('caAnalyticsCardGraphCurrentPeriodText');
      var currentPreviousPeriodText = $graph.data('caAnalyticsCardGraphCurrentPreviousPeriodText');
